class AnimalsNameRev{
	public static void main(String[] args)
	{
	  System.out.println("Start main in AnimalsNameRev");
	  ...
	  for(int animName=19;animName>=0;animName--)
	  {
	  ...
	  System.out.println("End main in AnimalsNameRev");
	}
}
